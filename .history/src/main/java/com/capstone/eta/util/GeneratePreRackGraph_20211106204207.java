...
public class GeneratePreRackGraph {
    ...
    GeneratePreRackGraph() {
        ...
        pairToEdgeName.put(Pair.with(1, 3), 0);
        pairToEdgeName.put(Pair.with(1, 4), 0);
        pairToEdgeName.put(Pair.with(4, 5), 0);
        pairToEdgeName.put(Pair.with(1, 6), 0);
        pairToEdgeName.put(Pair.with(6, 7), 0);
        pairToEdgeName.put(Pair.with(1, 8), 0);
        pairToEdgeName.put(Pair.with(8, 9), 0);
        pairToEdgeName.put(Pair.with(8, 10), 0);
    }
